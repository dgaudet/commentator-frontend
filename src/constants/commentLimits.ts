...
/** Maximum character length for outcome comments */
export const MAX_OUTCOME_COMMENT_LENGTH = 500

/** Maximum character length for personalized comments */
export const MAX_PERSONALIZED_COMMENT_LENGTH = 1000
