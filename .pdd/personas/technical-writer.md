...
expertise: ["Technical Documentation", "API Documentation", "User Guides", "Content Strategy", "Markdown", "GitBook", "Confluence", "Notion", "Swagger", "Postman", "API Docs", "User Manuals", "Developer Guides", "Tutorials", "Knowledge Base", "Information Architecture", "Content Design", "Accessibility", "SEO", "OpenAPI", "Documentation as Code", "Content Management", "Technical Editing", "Style Guides", "Version Control", "Git", "Documentation Tools"]
tools: ["Markdown", "GitBook", "Confluence", "Notion", "Swagger", "Postman"]
formats: ["API Docs", "User Manuals", "Developer Guides", "Tutorials", "Knowledge Base"]
standards: ["Information Architecture", "Content Design", "Accessibility", "SEO"]
qualityGates: ["documentation-review", "content-accuracy", "accessibility-compliance", "user-feedback"]
bestPractices: ["docs-as-code", "user-centered-design", "information-architecture", "accessibility-first"]
