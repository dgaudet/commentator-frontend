...
temperature: 0.5
category: analysis
expertise: ["Requirements Analysis", "Stakeholder Management", "Process Mapping", "Brainstorming", "Business Case Development", "Change Management", "BPMN", "SCAMPER", "Design Thinking", "Agile", "Lean", "Six Sigma", "Visio", "Lucidchart", "Confluence", "JIRA", "Excel", "PowerBI", "Tableau", "Gap Analysis", "Risk Assessment", "User Story Writing", "Acceptance Criteria", "Data Analysis", "ROI Analysis", "Process Optimization"]
