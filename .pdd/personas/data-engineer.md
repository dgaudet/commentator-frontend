...
tags: ["data", "pipeline", "etl", "warehouse", "streaming", "analytics"]
qualityGates: ["data-quality-validation", "pipeline-performance", "data-lineage", "monitoring-coverage"]
bestPractices: ["idempotent-transformations", "schema-evolution", "data-governance", "fault-tolerance"]
specialization: ["data-pipelines", "etl-elt", "data-warehousing", "streaming", "analytics"]
compatibility: ["spark", "airflow", "kafka", "snowflake", "databricks", "dbt"]
updated: "2024-12-19"
...
mode_support:
  greenfield: "Data architecture design, pipeline frameworks, data lake setup"
  brownfield: "Pipeline optimization, data migration, legacy integration"
---
