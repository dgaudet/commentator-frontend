# Claude Code Persona Activation Guide

This guide explains how to activate and use AI personas in Claude Code with the PDD Framework.
## Slash Commands

Use slash commands for precise persona activation:

### /Backend Developer
- **Role**: backend-developer
- **Usage**: `/Backend Developer`
- **Purpose**: # backend-developer
...
- **Usage**: `/Frontend Developer`
- **Purpose**: # frontend-developer
...
You can also activate personas using natural language patterns:
...
- "from the devops-engineer perspective"
- "from the devops-engineer role"  
- "in devops-engineer mode"
- "devops-engineer perspective on this"
...
- "from the qa-engineer role"  
- "in qa-engineer mode"
- "qa-engineer perspective on this"
...
- "from the system-architect perspective"
- "from the system-architect role"  
- "in system-architect mode"
- "system-architect perspective on this"
...
- "from the principal business analyst perspective"
- "from the principal business analyst role"  
- "in principal business analyst mode"
- "principal business analyst perspective on this"
...
- "as a principal data engineer"
- "from the principal data engineer perspective"
- "from the principal data engineer role"  
- "in principal data engineer mode"
- "principal data engineer perspective on this"

### Principal DevOps Engineer
- "as a principal devops engineer"
- "from the principal devops engineer perspective"
- "from the principal devops engineer role"  
- "in principal devops engineer mode"
- "principal devops engineer perspective on this"

### Principal Frontend Engineer
- "as a principal frontend engineer"
- "from the principal frontend engineer perspective"
- "from the principal frontend engineer role"  
- "in principal frontend engineer mode"
- "principal frontend engineer perspective on this"

### Principal Product Owner
- "as a principal product owner"
- "from the principal product owner perspective"
- "from the principal product owner role"  
- "in principal product owner mode"
- "principal product owner perspective on this"

### Principal QA Engineer
- "as a principal qa engineer"
- "from the principal qa engineer perspective"
- "from the principal qa engineer role"  
- "in principal qa engineer mode"
- "principal qa engineer perspective on this"
...
- "as a principal system architect"
- "from the principal system architect perspective"
- "from the principal system architect role"  
- "in principal system architect mode"
- "principal system architect perspective on this"
...
1. **Explicit Declaration**: "Switching to [persona] mode"
2. **Context Application**: Apply new persona to current discussion
3. **Boundary Maintenance**: Respect persona restrictions
4. **Role Consistency**: Stay in character throughout interaction
## Best Practices

- **Start Clear**: Begin with explicit persona activation
- **Stay Focused**: Maintain role boundaries throughout conversation
- **Switch Cleanly**: Explicitly declare when changing personas
- **Respect Limits**: Honor persona restrictions and scope
- **Exit Gracefully**: Clearly end persona mode when needed
## Troubleshooting

- **Boundary Violations**: Persona will refuse out-of-scope requests
- **Role Confusion**: Re-activate persona with explicit command
- **Context Loss**: Remind persona of current role and restrictions
---
